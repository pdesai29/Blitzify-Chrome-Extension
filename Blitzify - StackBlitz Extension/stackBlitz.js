(function (global, factory) {
  ...
  function getOrigin(options = {}) {
    const origin =
      typeof options.origin === "string" ? options.origin : DEFAULT_ORIGIN;
  ...
  function setFrameDimensions(frame, options = {}) {
    const height = Object.hasOwnProperty.call(options, "height")
      ? `${options.height}`
      : `${DEFAULT_FRAME_HEIGHT}`;
    const width = Object.hasOwnProperty.call(options, "width")
      ? `${options.width}`
      : void 0;
  ...
  class VM {
    constructor(port, config) {
      ...
      this.preview = {
        ...
        setUrl: (path = "/") => {
          if (typeof path !== "string" || !path.startsWith("/")) {
            throw new Error(
              `Invalid argument: expected a path starting with '/', got '${path}'`
            );
          }
          return this._rdc.request({
      ...
      Object.defineProperty(this.preview, "origin", {
        value:
          typeof config.previewOrigin === "string"
